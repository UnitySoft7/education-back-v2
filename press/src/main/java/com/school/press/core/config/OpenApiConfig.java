package com.school.press.core.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        ...
        var info = new Info()
                .title("Press System APIs")
                .version("1.0.0")
                .contact(contact)
                .description("Press System APIs")
