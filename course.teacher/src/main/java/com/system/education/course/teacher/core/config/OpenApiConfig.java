package com.system.education.course.teacher.core.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        ...
        var info = new Info()
                .title("COURSE-TEACHER-SERVICE RESTFUL API")
                .version("1.0.0")
                .contact(contact)
                .description("COURSE-TEACHER MICROSERVICE RESTFUL API")
