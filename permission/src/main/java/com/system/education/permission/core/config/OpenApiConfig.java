package com.system.education.permission.core.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        ...
        var info = new Info()
                .title("PERMISSION-SERVICE RESTFUL API")
                .version("1.0.0")
                .contact(contact)
                .description("PERMISSION MICROSERVICE RESTFUL API")
