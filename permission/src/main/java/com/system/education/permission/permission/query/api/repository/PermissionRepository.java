...
import com.system.education.permission.type.core.model.PermissionType;
...
public interface PermissionRepository extends ReactiveMongoRepository<Permission, String> {
    ...
    Flux<Permission> findByPermissionTypeCodeAndSemesterAndSchoolYear(@Param("permissionType") String permissionTypeCode, @Param("semester") String semester, @Param("schoolYear") String schoolYear);
