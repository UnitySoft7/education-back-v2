package com.school.evaluate.core.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        ...
        var info = new Info()
                .title("Evaluate System APIs")
                .version("1.0.0")
                .contact(contact)
                .description("Evaluate System APIs")
