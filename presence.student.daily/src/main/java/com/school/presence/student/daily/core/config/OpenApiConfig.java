package com.school.presence.student.daily.core.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        ...
        devServer.setUrl("http://127.0.0.1:9928");https://presence-student-daily.onrender.com
        devServer.setDescription("Server URL development environment");

        var prodServer = new Server();
        prodServer.setUrl("http://10.201.183.121:9928");
        prodServer.setDescription("Server URL production environment");

        var prodServer2 = new Server();
        prodServer.setUrl("https://presence-student-daily.onrender.com");
        prodServer.setDescription("Server URL production environment");
        ...
        var info = new Info()
                .title("PresenceStudentDaily System APIs")
                .version("1.0.0")
                .contact(contact)
                .description("PresenceStudentDaily System APIs")
