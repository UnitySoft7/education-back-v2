package com.school.presence.student.core.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        ...
        var info = new Info()
                .title("PresenceInClass System APIs")
                .version("1.0.0")
                .contact(contact)
                .description("PresenceInClass System APIs")
