...
public record TransactionResponse(
        String transaId, String minosCode, String studentCode, String studentFullname,
        String trimester, double amount, double maxamount, String schoolYear,
        String establishmentName, String establishmentCode, String sectionName,
        String sectionCode, String classroomName, String classroomCode,
