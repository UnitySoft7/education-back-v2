...
@Schema(name = "Schedule Updated Course Command")
public record ScheduleUpdatedCourseCommand(
        @NotNull(message = "Required") @Pattern(regexp = "^[A-Z0-9]{2,40}$", message = "Ce champ doit avoir de 2 jusqu'à 40 caractères") String scheduleCode,
