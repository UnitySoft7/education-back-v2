...
@Schema(name = "Schedule updated command")
public record ScheduleUpdatedCommand(
        @NotNull(message = "Required") @Pattern(regexp = "^[0-9A-Z]{6,}$", message = "Ce champ doit avoir de 2 jusqu'à 40 caractères") String code,
        String index,
...
//        @NotNull(message = "Required") @Pattern(regexp = "^[0-9A-Z]{6,}$", message = "Ce champ doit avoir de 6 jusqu'à 40 caractères") String courseCode
