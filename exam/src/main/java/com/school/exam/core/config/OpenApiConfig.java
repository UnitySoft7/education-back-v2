package com.school.exam.core.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        ...
        var info = new Info()
                .title("Exam System APIs")
                .version("1.0.0")
                .contact(contact)
                .description("Exam System APIs")
