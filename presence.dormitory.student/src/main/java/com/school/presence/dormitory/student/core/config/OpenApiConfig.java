package com.school.presence.dormitory.student.core.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        ...
        var info = new Info()
                .title("PresenceInDormitory System APIs")
                .version("1.0.0")
                .contact(contact)
                .description("PresenceInDormitory System APIs")
