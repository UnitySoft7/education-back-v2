...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        ...
        prodServer.setUrl("http://10.201.183.71:9914");
        prodServer.setDescription("Server URL production environment");

        var prodServer2 = new Server();
        prodServer.setUrl("https://examination-et7w.onrender.com");
        prodServer.setDescription("Server URL production environment");
        ...
        var info = new Info()
                .title("Examination System APIs")
                .version("1.0.0")
                .contact(contact)
                .description("Examination System APIs")
