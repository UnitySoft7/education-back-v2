package com.school.evaluation.core.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        ...
        var info = new Info()
                .title("Evaluation System APIs")
                .version("1.0.0")
                .contact(contact)
                .description("Evaluation System APIs")
