package com.school.dormitory.core.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        ...
        var info = new Info()
                .title("Dormitory System APIs")
                .version("1.0.0")
                .contact(contact)
                .description("Dormitory System APIs")
