package com.system.education.parent.core.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        ...
        var info = new Info()
                .title("PARENT-SERVICE RESTFUL API")
                .version("1.0.0")
                .contact(contact)
                .description("PARENT MICROSERVICE RESTFUL API")
