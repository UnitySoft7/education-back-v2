package com.school.course.core.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        ...
        var info = new Info()
                .title("Course System APIs")
                .version("1.0.0")
                .contact(contact)
                .description("Course System APIs")
