package com.school.classroom.core.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        ...
        var info = new Info()
                .title("Classroom SYSTEM API")
                .version("1.0.0")
                .contact(contact)
                .description("Classroom SYSTEM API")
