package com.system.education.infirmary.core.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        ...
        var info = new Info()
                .title("STUDENT-SERVICE RESTFUL API")
                .version("1.0.0")
                .contact(contact)
                .description("INFIRMARY MICROSERVICE RESTFUL API")
