package com.system.education.classes.course.core.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        ...
        var info = new Info()
                .title("CLASS-COURSE-SERVICE RESTFUL API")
                .version("1.0.0")
                .contact(contact)
                .description("CLASS-COURSE MICROSERVICE RESTFUL API")
