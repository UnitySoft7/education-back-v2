package com.system.education.bulletin.core.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        ...
        var info = new Info()
                .title("BULLETIN-SERVICE RESTFUL API")
                .version("1.0.0")
                .contact(contact)
                .description("BULLETIN MICROSERVICE RESTFUL API")
