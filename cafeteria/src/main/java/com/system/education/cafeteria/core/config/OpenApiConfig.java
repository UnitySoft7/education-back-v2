package com.system.education.cafeteria.core.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        ...
        var info = new Info()
                ...
                .version("1.0.0")
                .contact(contact)
                .description("STUDENT MICROSERVICE RESTFUL API")
