package com.system.education.cafeteria.product.core.payload.impl;

import com.system.education.cafeteria.core.common.ProductCode;
import com.system.education.cafeteria.product.core.payload.ProductPayload;
import com.system.education.cafeteria.product.query.api.repository.ProductRepositories;
...
public class ProductPayloadImpl implements ProductPayload {
    ...
    public Mono<String> getCode(){
        return productRepository.count().flatMap(aLong -> {
            if (aLong == 0) {
                return Mono.just("ESCPC10000001");
            }
            else {
