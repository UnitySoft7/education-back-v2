package com.school.presence.teacher.core.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        ...
        var info = new Info()
                .title("PresenceTeacher System APIs")
                .version("1.0.0")
                .contact(contact)
                .description("PresenceTeacher System APIs")
