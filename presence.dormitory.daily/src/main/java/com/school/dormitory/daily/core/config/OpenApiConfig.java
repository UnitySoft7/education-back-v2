package com.school.dormitory.daily.core.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        ...
        var info = new Info()
                .title("DormitoryStudentDaily System APIs")
                .version("1.0.0")
                .contact(contact)
                .description("DormitoryStudentDaily System APIs")
